...
export default {
  ...
  methods: {
    ...mapActions(["fetchStarshipDetail"]),
  },
  computed: {
    ...mapGetters(["starshipDetail", "loadingStatusStarships"]),
  },
  created() {
    this.fetchStarshipDetail(this.$route.params.id);
  },
};
</script>
